...
**Solution**
To create such a sequence, we use the `seq` function. The syntax of the function in this instance is intuitive, using `from`, `to`, and `by` as arguments.
```{r}
#| size: "scriptsize"
(part.g = seq(from = 1, to = 10, by = 2)) 
```
